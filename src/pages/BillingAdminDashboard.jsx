...
const BillingAdminDashboard = () => {
    ...
    const fetchKitchenData = async () => {
        try {
            ...
            const kitchenRes = await fetch(`${API_URL}/api/billing-admin/my-kitchen`, {
            ...
            const ordersRes = await fetch(`${API_URL}/api/billing-admin/my-kitchen/orders`, {
                headers: { 'Authorization': `Bearer ${token}` }
            });
            ...
            const inventoryRes = await fetch(`${API_URL}/api/billing-admin/my-kitchen/inventory`, {
                headers: { 'Authorization': `Bearer ${token}` }
            });
